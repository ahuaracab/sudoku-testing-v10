...
describe('Numbers', { viewportHeight: 1000, viewportWidth: 1000 }, () => {
  ...
  it('calls on click number', () => {
    ...
    cy.contains('.status__number', '2').click()
    cy.get('@click').should('have.been.calledWith', '2')
    cy.contains('.status__number', '3').click()
    cy.get('@click').should('have.been.calledWith', '3')
  })
